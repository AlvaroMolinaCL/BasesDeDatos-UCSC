...
if($_POST['numEntrada'] != "" && $_POST['fechaEntrada'] != "" && $_POST['horaEntrada'] == ""
        && $_POST['valorEntrada'] == "" && $_POST['CategoriaPublico'] == "" && $_POST['Descuento'] == "" && $_POST['rutCliente'] == "") 
{
    ...
    $actualizacion_entradaVirtual = pg_query($conexion, $sql_entrada);

    if($actualizacion_entradaVirtual) {
