...
if($_POST['idEvento'] != "" && $_POST['nombreEvento'] != "" && $_POST['descripcionEvento'] == ""
        ...
        && $_POST['duracionEvento'] == "" && $_POST['categoriaEvento']== "0" && $_POST['restriccion'] == "0" && $_POST['codLugarEvento'] == "") 
{
...
{
    $Id_evento = $_POST['idEvento'];
    $Codigo_Lugar_evento = $_POST['codLugarEvento'];

    $sql_evento = "UPDATE evento_presencial SET fk_codigo_lugar = '".$Codigo_Lugar_evento."' WHERE fk_id = '".$Id_evento."'";
